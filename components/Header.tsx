...
const Header = () => {
  ...
  return (
    <header className="flex items-center px-8 py-4 font-serif bg-gray-800 text-white">
      ...
      <input
        type="text"
        placeholder="Search"
        className="mx-4 w-64 px-2 py-1 rounded-md font-sans text-sm bg-gray-700 focus:bg-gray-200 focus:text-black"
      />
